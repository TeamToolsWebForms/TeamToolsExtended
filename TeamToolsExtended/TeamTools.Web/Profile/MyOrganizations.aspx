<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyOrganizations.aspx.cs" Inherits="TeamTools.Web.Profile.MyOrganizations" %>
                            ...
                            <ContentTemplate>
                                <div class="form-inline">
                                    <div class="form-group">
                                        <label for="SearchOrganizations">My Organizations</label>
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                ...
                                <asp:DataPager ID="DataPagerMyOrganizationsListView" ClientIDMode="Static" runat="server"
                                    PagedControlID="MyOrganizationsListView" PageSize="5">
                                    <Fields>
