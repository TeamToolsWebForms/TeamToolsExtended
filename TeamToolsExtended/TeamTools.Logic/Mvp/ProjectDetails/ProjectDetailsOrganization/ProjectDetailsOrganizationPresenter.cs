...
namespace TeamTools.Logic.Mvp.ProjectDetails.ProjectDetailsOrganization
{
    public class ProjectDetailsOrganizationPresenter : Presenter<IProjectDetailsOrganizationView>
    {
        private readonly IProjectTaskService projectTaskService;
        private readonly IProjectService projectService;
        private readonly IProjectTaskFactory projectTaskFactory;

        public ProjectDetailsOrganizationPresenter(IProjectDetailsOrganizationView view, IProjectService projectService, IProjectTaskService projectTaskService, IProjectTaskFactory projectTaskFactory)
            : base(view)
        {
